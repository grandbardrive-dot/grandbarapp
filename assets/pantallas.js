...
const PANTALLAS = [
  {
    ...
    items: [
      ...
      { n:'Manual de visita',       r:'manual-vendedores/visita.html',      nota:'El recorrido que hace en el punto de venta. Necesita cliente elegido.' },
  ...
  },
  {
    ...
    items: [
      ...
      { n:'Secciones del manual',r:'manual-vendedores/admin-secciones.html',        nota:'Estructura del manual: secciones, textos y herramientas.' },
  ...
  },
  {
    ...
    items: [
      ...
      { n:'Tareas de la auditoría', r:'auditoria-tareas.html',                  nota:'Lo que quedó por arreglar de los manuales, repartido entre Josefina, Nahuel, Luciana y Dirección.' },
      ...
      { n:'Panel clásico',      r:'manual-vendedores/admin.html?tab=visitas',nota:'Visitas, compromisos y acciones en crudo.' },
